...
<head>
    ...
    <meta name="description" content="opensanca | Meetup Sancarlense sobre opensource, startups e beer code.">
    <title>opensanca - meetup</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                  <img src="img/logo.png" alt="" class="img-responsive pull-left" width="15%" />
                    <span class="light">opensanca</span> | Meetup
                </a>
            </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h1 class="brand-heading">
                          opensanca</h1>
                        <p class="intro-text">Seja bem vindo, ao meetup <em>SanCarlense</em> sobre opensource, inovação, tecnologia e happy hour!<br>Faça parte!</p>
